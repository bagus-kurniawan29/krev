...
<head>
    ...
    <link class="rounded-full" rel="shortcut icon" href="/logo1.ico" type="image/x-icon">
...
<body class="text-white min-h-screen flex flex-col justify-between selection:bg-brand selection:text-black">
    ...
    <!-- Hero Section -->
    <main id="home" class="w-full max-w-7xl mx-auto px-6 flex items-center pt-32 pb-16 md:py-40 relative scroll-mt-24">
        <div class="absolute bg-brand/10 w-72 h-72 md:w-96 md:h-96 rounded-full blur-[120px] right-0 top-12 mix-blend-screen pointer-events-none"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center w-full">
            <div class="md:col-span-7 flex flex-col space-y-6 text-left z-10">
                ...
                <p class="text-gray-400 text-base md:text-xl max-w-xl font-light leading-relaxed">
                ...
                <div class="flex flex-wrap gap-4 pt-4">
                    <a href="#services" class="bg-brand text-black hover:bg-white px-6 md:px-8 py-4 rounded-xl font-bold tracking-wide shadow-lg shadow-brand/10 transition-all duration-300 transform hover:-translate-y-1 text-center w-full sm:w-auto">
                        Our Services
                    </a>
                    <a href="#recent" class="bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 px-6 md:px-8 py-4 rounded-xl font-bold tracking-wide transition-all duration-300 text-center w-full sm:w-auto">
                        View Project
                    </a>
                </div>
            </div>
            ...
            <div class="md:col-span-5 relative flex justify-center items-center">
                <div class="absolute w-72 h-72 bg-brand/5 rounded-full blur-[100px] -z-10"></div>
    ...
    <!-- Stats Section (Diperbaiki Gridnya agar Kokoh di Mobile) -->
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 bg-[#090909] p-6 md:p-12 mx-auto rounded-xl w-full max-w-7xl border border-neutral-900">
        <div class="flex flex-col justify-center md:border-r border-neutral-800 text-center p-2">
            <h1 class="text-brand text-4xl md:text-6xl font-bold">150+</h1>
            <p class="font-mono text-xs md:text-sm text-neutral-400 mt-2">Project Completed</p>
        </div>

        <div class="flex flex-col justify-center md:border-r border-neutral-800 text-center p-2">
            <h1 class="text-brand text-4xl md:text-6xl font-bold">12M+</h1>
            <p class="font-mono text-xs md:text-sm text-neutral-400 mt-2">Ad Reach / Views</p>
        </div>

        <div class="flex flex-col justify-center md:border-r border-neutral-800 text-center p-2">
            <h1 class="text-brand text-4xl md:text-6xl font-bold">99%</h1>
            <p class="font-mono text-xs md:text-sm text-neutral-400 mt-2">Client Satisfaction</p>
        </div>

        <div class="flex flex-col justify-center text-center p-2">
            <h1 class="text-brand text-4xl md:text-6xl font-bold">3+</h1>
            <p class="font-mono text-xs md:text-sm text-neutral-400 mt-2">Years Experience</p>
        </div>
    </div>

    <!-- Service Section -->
    <div id="services" class="w-full max-w-7xl mx-auto px-6 flex flex-col items-start py-16 md:py-28 relative scroll-mt-24">
        <div class="absolute bg-brand/10 w-96 h-96 rounded-full blur-[120px] left-0 bottom-12 mix-blend-screen pointer-events-none"></div>
        <p class="text-brand font-mono text-xl mb-2">// WHAT WE DO?</p>
        <div class="flex flex-col md:flex-row gap-4 mb-8">
            <h1 class="text-4xl md:text-6xl font-bold w-full md:max-w-xl">Layanan Utama Kami</h1>
            <p class="text-[#9CA3AF] max-w-2xl text-base md:text-lg my-auto">Kami memadukan kreativitas visual tingkat tinggi dengan kode pemrograman modern yang menghasilkan performa bisnis yang eksponensial.</p>    
        </div>
    ...
    <div id="project" class="w-full max-w-7xl mx-auto px-6 flex flex-col items-start py-16 relative scroll-mt-24">
        <div class="flex flex-col bg-[#090909] max-w-7xl w-full rounded-xl p-6 md:p-8 border border-zinc-900">
            <p class="text-brand font-mono">// DYNAMIC ESTIMATION</p>
            
            <div class="flex lg:flex-row gap-8 flex-col mt-4">
                <div class="flex flex-col max-w-2xl w-full">
                    <h1 class="font-bold text-4xl md:text-6xl mt-4 leading-tight">Berapa perkiraan waktu pengerjaan proyek Anda?</h1>
                    <p class="text-[#9CA3AF] mt-6 text-base md:text-lg">Pilih tipe layanan dan kapasitas pengerjaan di samping untuk melihat perkiraan estimasi pengerjaan dari tim profesional kami.</p>
                    
                    <p class="mt-6 font-mono text-[#9CA3AF] text-sm tracking-wider">PILIH LAYANAN</p>
                    <div class="flex flex-wrap gap-3 mt-2">
                        <button class="btn-layanan border-brand text-brand bg-brand/10 rounded-lg p-3 md:p-4 font-semibold transition text-sm md:text-base" data-layanan="Video Editing">Video Editing</button>
                        <button class="btn-layanan border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base" data-layanan="Digital Ads">Digital Ads</button>
                        <button class="btn-layanan border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base" data-layanan="Coding">Coding Web</button>
                    </div>
                    
                    <p class="mt-6 font-mono text-[#9CA3AF] text-sm tracking-wider">SKALA PROJECT</p>
                    <div class="flex flex-wrap gap-3 mt-2">
                        <button class="btn-skala border-brand text-brand bg-brand/10 rounded-lg p-3 md:p-4 font-semibold transition text-sm md:text-base" data-skala="Standar">Standar</button>
                        <button class="btn-skala border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base" data-skala="Menengah">Menengah</button>
                        <button class="btn-skala border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base" data-skala="Besar">Besar</button>
                    </div>
                </div>
                
                <div class="bg-[#0F0F0F] flex flex-col p-6 md:p-8 rounded-xl w-full lg:max-w-md border border-zinc-900 justify-between">
                    <div>
                        <p class="font-mono text-[#9CA3AF] text-sm">// RINGKASAN ESTIMASI</p>
                        <p class="mt-6 text-[#9CA3AF] text-sm">Total Perkiraan Waktu</p>
                        <h1 id="hari_kerja" class="font-mono text-brand text-4xl md:text-5xl font-bold mt-1">3 - 5 Hari kerja</h1>
                        
                        <div class="bg-[#0B0B0B] rounded-xl flex flex-col p-4 md:p-6 gap-4 mt-6 border border-zinc-900/50">
                            <div class="flex justify-between text-xs md:text-sm gap-2">
                                <p class="text-[#9CA3AF] shrink-0">Cakupan Layanan:</p>
                                <p id="output_layanan" class="font-medium text-white text-right">Video Editing (Standar)</p>
                            </div>
                            <div class="flex justify-between text-xs md:text-sm gap-2">
                                <p class="text-[#9CA3AF] shrink-0">Rekomendasi Tim:</p>
                                <p id="output_tim" class="font-medium text-white text-right max-w-[200px]">1 Editor & 1 Creative Director</p>
                            </div>
                            <div class="flex justify-between text-xs md:text-sm gap-2">
                                <p class="text-[#9CA3AF] shrink-0">Prioritas Antrean:</p>
                                <p id="output_prioritas" class="font-mono text-brand font-bold">TINGGI</p>
                            </div>
                        </div>
                    </div>
                    <button class="bg-white text-black p-4 text-base rounded-xl font-bold hover:bg-zinc-200 transition w-full mt-6">
    ...
    <!-- Recent Work Section -->
    <div id="recent" class="flex flex-col w-full max-w-7xl p-6 md:p-8 mx-auto scroll-mt-24">
    ...
    <!-- Contact Form Section (Dibuat Full Responsive Flex Antara Teks dan Form) -->
    <div id="contact" class="w-full max-w-7xl mx-auto px-6 py-16 relative scroll-mt-24 mb-20">
        <div class="flex flex-col lg:flex-row bg-[#090909] max-w-7xl w-full rounded-xl p-6 md:p-8 border border-zinc-900 relative gap-12">
            <div class="absolute bg-brand/10 w-96 h-96 rounded-full blur-[120px] right-0 top-12 mix-blend-screen pointer-events-none -z-10"></div>
            
            <!-- Teks Kiri -->
            <div class="flex flex-col w-full lg:w-2/5 justify-between gap-8">
                <div>
                    <p class="font-mono text-brand text-xl">// WHAT WE BUILD NEXT?</p>
                    <h1 class="text-4xl md:text-6xl font-bold mt-2">Mulai Proyek Hebat Anda</h1>
                    <p class="text-[#9CA3AF] mt-4 text-base md:text-lg">Hubungi tim KREV untuk merealisasikan visi digital Anda. Kami siap merespons kurang dari 24 jam kerja.</p>
                </div>
                
                <div class="flex flex-col gap-6">
                    <div class="flex gap-5">
                        <i class="fa-solid fa-envelope text-brand p-4 bg-[#1a1a1a] rounded-lg h-fit"></i>
                        <div class="flex flex-col">
                            <p class="text-[#6B7280] text-sm">Hubungi Kami</p>
                            <p class="text-base md:text-lg font-semibold">Krev@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex gap-5">
                        <i class="fa-solid fa-location-dot text-brand p-4 bg-[#1a1a1a] rounded-lg h-fit"></i>
                        <div class="flex flex-col">
                            <p class="text-[#6B7280] text-sm">Alamat Kami</p>
                            <p class="text-base md:text-lg font-semibold leading-snug">Rumbuk, Lombok Timur, Nusa Tenggara Barat, Indonesia</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Form Kanan -->
            <form action="" method="POST" class="w-full lg:w-3/5 flex flex-col gap-6 z-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                    <div class="flex flex-col gap-2">
                        <label for="nama_lengkap" class="font-mono text-xs tracking-widest text-zinc-500 uppercase">Nama Lengkap</label>
                        <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="John Doe" class="w-full bg-[#121212]/40 border border-zinc-800/80 rounded-xl p-4 text-white placeholder-zinc-700 text-base focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/30 transition-all duration-300" required>
                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="email" class="font-mono text-xs tracking-widest text-zinc-500 uppercase">Alamat Email</label>
                        <input type="type" id="email" name="email" placeholder="john@example.com" class="w-full bg-[#121212]/40 border border-zinc-800/80 rounded-xl p-4 text-white placeholder-zinc-700 text-base focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/30 transition-all duration-300" required>
                    </div>
                </div>

                <div class="flex flex-col gap-2 w-full relative">
                    <div class="absolute bg-brand/10 w-72 h-72 rounded-full blur-[100px] -right-20 -top-20 mix-blend-screen pointer-events-none z-0"></div>
                    <label for="layanan" class="font-mono text-xs tracking-widest text-zinc-500 uppercase relative z-10">Layanan Yang Diminati</label>
                    <div class="relative w-full z-10">
                        <select id="layanan" name="layanan" class="w-full bg-[#121212]/60 border border-zinc-800/80 rounded-xl p-4 text-white text-base focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/30 transition-all duration-300 appearance-none cursor-pointer backdrop-blur-sm" required>
                ...
                <div class="flex flex-col gap-2 w-full">
                    <label for="detail_proyek" class="font-mono text-xs tracking-widest text-zinc-500 uppercase">Detail Proyek</label>
                    <textarea id="detail_proyek" name="detail_proyek" rows="5" placeholder="Ceritakan konsep atau gol proyek yang ingin Anda capai..." class="w-full bg-[#121212]/40 border border-zinc-800/80 rounded-xl p-4 text-white placeholder-zinc-700 text-base resize-none focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/30 transition-all duration-300" required></textarea>
                </div>

                <button type="submit" class="w-full bg-brand text-black font-bold text-base py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-brand/90 active:scale-[0.99] transition-all duration-300 shadow-[0_4px_20px_rgba(163,230,53,0.15)]">
                    Kirim Pesan Ke KREV <i class="fa-solid fa-paper-plane text-sm"></i>
                </button>
            </form>
        </div>
    </div>
    ...
    <!-- Footer -->
    <footer class="w-full max-w-7xl mx-auto px-6 py-6 border-t border-neutral-900 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-neutral-600 font-mono mt-auto">
        <p>© 2026 KREV Studio. All rights reserved.</p>
        <div class="flex gap-6">
            <a href="#" class="hover:text-neutral-400 transition-colors">Instagram</a>
            <a href="#" class="hover:text-neutral-400 transition-colors">GitHub</a>
            <a href="#" class="hover:text-neutral-400 transition-colors">LinkedIn</a>
        </div>
    </footer>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        let layananActive = "Video Editing";
        let skalaActive = "Standar";

        const btnLayanan = document.querySelectorAll('.btn-layanan');
        const btnSkala = document.querySelectorAll('.btn-skala');

        function hitungEstimasi() {
            const res = ReillyEstimasi[layananActive][skalaActive];
            document.getElementById('hari_kerja').innerText = res.waktu;
            document.getElementById('output_layanan').innerText = `${layananActive} (${skalaActive})`;
            document.getElementById('output_tim').innerText = res.tim;
            document.getElementById('output_prioritas').innerText = res.prioritas;
        }

        btnLayanan.forEach(b => {
            b.addEventListener('click', () => {
                btnLayanan.forEach(x => x.className = "btn-layanan border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base");
                b.className = "btn-layanan border-brand text-brand bg-brand/10 rounded-lg p-3 md:p-4 font-semibold transition text-sm md:text-base";
                layananActive = b.getAttribute('data-layanan');
                hitungEstimasi();
            });
        });
        ...
        btnSkala.forEach(b => {
            b.addEventListener('click', () => {
                btnSkala.forEach(x => x.className = "btn-skala border-zinc-800 text-[#9CA3AF] border rounded-lg p-3 md:p-4 transition text-sm md:text-base");
                b.className = "btn-skala border-brand text-brand bg-brand/10 rounded-lg p-3 md:p-4 font-semibold transition text-sm md:text-base";
                skalaActive = b.getAttribute('data-skala');
                hitungEstimasi();
            });
        });

        // Logika 2: Filter Portofolio
        ...
        filterButtons.forEach(button => {
            button.addEventListener("click", () => {
                ...
                filterButtons.forEach(btn => btn.className = "btn-filter bg-[#0F0F0F] text-zinc-400 hover:text-white py-2.5 px-5 rounded-xl transition");
        ...
        // Logika 3: Active Scroll Navbar
        const navLinks = document.querySelectorAll(".nav-link");
        const sections = document.querySelectorAll("main[id], div[id]");
            ...
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    ...
                    navLinks.forEach((link) => {
                        ...
                        if (href === idAktif) {
                            link.className = "nav-link text-brand transition-colors duration-300";
                        } else {
                            link.className = "nav-link text-gray-400 hover:text-white transition-colors duration-300";
                        }
                    });
                }
            });
